...
var serblog1 = GALLERY[0];
var serblog2 = GALLERY[1];
var serblog3 = GALLERY[2];
var serblog4 = GALLERY[3];
							...
							<div className="container">
								<div className="row service-area1">
									<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div className="icon-bx-wraper text-center service-box1" style={{backgroundImage: "url(" + serblog1 + ")", backgroundRepeat:"no-repeat", backgroundSize:"contain"}}>
											<div className="icon-content"></div>
										</div>
									</div>
									<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div className="icon-bx-wraper text-center service-box1" style={{backgroundImage: "url(" + serblog2 + ")", backgroundRepeat:"no-repeat", backgroundSize:"contain"}}>
											<div className="icon-content"></div>
										</div>
									</div>
									<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div className="icon-bx-wraper text-center service-box1" style={{backgroundImage: "url(" + serblog3 + ")", backgroundRepeat:"no-repeat", backgroundSize:"contain"}}>
									...
									<div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div className="icon-bx-wraper text-center service-box1" style={{backgroundImage: "url(" + serblog4 + ")", backgroundRepeat:"no-repeat", backgroundSize:"contain"}}>
											<div className="icon-content"></div>
										</div>
									</div>
									{/* 
