questions = [
   ...
   {"QUESTION":"תיאור סלוגן ראשון"  , "VARNAME": "subHederDescriptionL", "type": "textarea"},
   {"QUESTION":"משפט קצר סלוגן ראשון ", "VARNAME": "subHederParagraphL", "type": "textarea"},
   {"QUESTION":"סלוגן שני "  , "VARNAME": "subHederR", "type": "textarea"},
   {"QUESTION":"תיאור סלוגן שני", "VARNAME": "subHederDescriptionR", "type": "textarea"},
   {"QUESTION":"משפט קצר סלוגן שני "  , "VARNAME": "subHederParagraphR", "type": "textarea"},
   {"QUESTION": "תמונות לגלריה", "VARNAME": "galleryurl1", "type": "image", "limit": 1, "dimension": "360x230"},
   {"QUESTION": "תמונות לגלריה", "VARNAME": "galleryurl2", "type": "image", "limit": 3, "dimension": "360x230"},
...
replacements = [
    ...
    {"KEYWORD": "GALLERY1", "VARNAME": "galleryurl1", "SRC": "src/New/components/ContactInfo.js"},
    ...
    {"KEYWORD": "GALLERY2", "VARNAME": "galleryurl2", "SRC": "src/New/components/Department.js"},
